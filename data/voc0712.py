...
VOC_CLASSES = ('helmet','head','person','')
...
# データセットのディレクトリを取得
dir_voc = osp.join(dir_cur, "..", "datasets")
# データセットの絶対パスを設定
...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root,
        ...
        self.ids = list()
        for (imgdir, name) in image_sets:
            rootpath = osp.join(self.root, imgdir)
